/*    occurstwicebs: program for building library of all k-mers,
 *    assuming bisulfite treatment, occurring twice in a genome
 *
...
main(int argc, const char **argv) {
  ...
  try {
    ...
    OptionParser opt_parse("occurstwicebs", "program for building library "
			   "of all k-mers occurring twice in a bisulfite "
			   "treated genome.",
			   "<fasta-chrom-file>");
